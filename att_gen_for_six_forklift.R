...
for(file_name_i in wd_filenames)
{
  ...
  select(
      ...
      contains("A1_Monat"),
      contains("A0_Jahr"),
      contains("SR_DAC_3_Drehzahl_Lenkrad"),
      contains("SR_DAC_2_Lenkwinkel"),
      contains("SR_DAC_1_Drehzahl_PM"),
      contains("SR_DAC_0_Drehmoment_PM"),
      contains("UE_DAC_6_Auslenkung_Z_prop"),
      contains("UE_DAC_5_Auslenkung_Y_prop"),
      contains("UE_DAC_4_Auslenkung_X_prop"),
      contains("UE_DAC_7_Auslenkung_W_prop"),
      contains("SR_DAC_7_Auslenkung_Zusatz_2"),
      contains("SR_DAC_6_Auslenkung_Zusatz_1"),
      contains("SR_DAC_5_Auslenkung_Neigen"),
      contains("SR_DAC_4_Auslenkung_Heben"),
      contains("UE_DAC_3_Drehzahl_FM_2"),
      contains("UE_DAC_2_Drehzahl_FM_1"),
      contains("UE_DAC_1_Drehmoment_FM_2"),
      contains("UE_DAC_0_Drehmoment_FM_1")
    )
  ...
  tdf_attributes = mutate(
    ...
    mutate(
      ...
      speed_torque_1_factor = factor(paste(speed_1_modulo_factor,torque_1_modulo_factor,sep=","),levels = factor_variations(reso_m)),
      speed_torque_2_factor = factor(paste(speed_2_modulo_factor,torque_2_modulo_factor,sep=","),levels = factor_variations(reso_m)),
